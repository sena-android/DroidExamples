 ...
 * 
 * La editorial es el framework android que llama el método getView de cada componente
 * y el adaptador es el pintor contrato en esta ocación para dibujar las ilustraciones. Y la
 * página con formato es el id al xml que define cada item. *  
 * 
 * @author J.Gabriel G. - llanox
 * **/

public class ListAdapterOptionOne extends ArrayAdapter<Data>{
	...
	public ListAdapterOptionOne(Context context,int idView, List<Data> info) {
